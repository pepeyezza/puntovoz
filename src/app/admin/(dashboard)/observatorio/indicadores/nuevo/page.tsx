    ...
    <div>
      ...
      <form action={createIndicador} className="mt-8 max-w-lg space-y-5">
        <div>
          ...
          <input name="nombre" type="text" required placeholder="Ej: Poblacion total Argentina" className="mt-2 w-full rounded-xl border border-principal/15 bg-secundario px-4 py-3 text-sm outline-none focus-visible:border-acento" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-sm font-medium">Valor</label>
            <p className="text-xs text-principal/40 mt-0.5">Admite cualquier numero, incluidos grandes</p>
            <input name="valor" type="text" required placeholder="Ej: 46234830" className="mt-2 w-full rounded-xl border border-principal/15 bg-secundario px-4 py-3 text-sm outline-none focus-visible:border-acento" />
          </div>
          <div>
        ...
        <div>
          ...
          <input name="periodo" type="text" required placeholder="Ej: 2024-Q1, Mayo 2025, Ano 2023" className="mt-2 w-full rounded-xl border border-principal/15 bg-secundario px-4 py-3 text-sm outline-none focus-visible:border-acento" />
        </div>
        <div>
        ...
        <div className="flex gap-3 pt-2">
          ...
          <a href="/admin/observatorio/indicadores" className="rounded-lg border border-principal/15 px-6 py-3 text-sm font-medium hover:border-acento hover:text-acento">Cancelar</a>
        </div>
      </form>
    </div>
  );
