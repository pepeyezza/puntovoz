...
export default function NuevoVideoPage() {
  return (
    <div>
      ...
      <p className="mt-1 text-principal/60">Pega la URL del video de YouTube.</p>
      <form action={createVideo} className="mt-8 max-w-xl space-y-5">
        ...
        <div>
          ...
          <input name="youtubeUrl" type="url" required placeholder="https://www.youtube.com/watch?v=..." className="mt-2 w-full rounded-xl border border-principal/15 bg-secundario px-4 py-3 text-sm outline-none focus-visible:border-acento" />
        </div>
        <div>
          <label className="text-sm font-medium">Categoria</label>
          <input name="category" type="text" placeholder="Ej: Cultura" className="mt-2 w-full rounded-xl border border-principal/15 bg-secundario px-4 py-3 text-sm outline-none focus-visible:border-acento" />
        </div>
        <div>
