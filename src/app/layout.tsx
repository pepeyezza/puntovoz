  ...
  return (
    <html lang="es">
      <head>
        ...
        <Script id="google-analytics" strategy="afterInteractive">{`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-8R7L4ESNV2');`}</Script>
      </head>
      <body>
        <Header />
        <main>{children}</main>
